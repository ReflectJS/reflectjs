...
import fs from "fs";
import { HtmlDocument, HtmlElement } from '../../src/preprocessor/htmldom';
import HtmlParser from "../../src/preprocessor/htmlparser";
import { COMMENT_NODE, ELEMENT_NODE, TEXT_NODE } from "../../src/preprocessor/dom";

const rootPath = process.cwd() + '/test/preprocessor/htmlparser';
